...
type User struct {
	...
	// Bio is a short free-text description the user writes about themselves.
	Bio *string `json:"bio,omitempty" db:"bio"`

	// GitHub is the user's GitHub username.
	GitHub *string `json:"github,omitempty" db:"github"`

	// Codeforces is the user's Codeforces handle.
	Codeforces *string `json:"codeforces,omitempty" db:"codeforces"`

	// AtCoder is the user's AtCoder handle.
	AtCoder *string `json:"atcoder,omitempty" db:"atcoder"`

	// Website is the user's personal website URL.
	Website *string `json:"website,omitempty" db:"website"`

	// AvatarURL is the storage key for the user's profile picture.
	// If set, the avatar is served at GET /users/{username}/avatar.
