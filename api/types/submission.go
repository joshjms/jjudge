...
type Submission struct {
	...
	// ProblemTitle is the title of the problem this submission is for.
	// This field is populated when fetching submissions and is not stored in the submissions table.
	ProblemTitle string `json:"problem_title,omitempty" db:"-"`
...
// SubmissionJob represents the payload sent to the judge queue.
type SubmissionJob struct {
	// Submission is the persisted submission record (including source code).
	Submission Submission `json:"submission"`

	// Problem includes full problem metadata and test cases.
