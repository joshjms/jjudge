...
type ContestRepository interface {
	ListContests(ctx context.Context, offset, limit int, publicOnly bool) ([]types.Contest, int, error)
	ListPendingContests(ctx context.Context, offset, limit int) ([]types.Contest, int, error)
	ListContestsByOwner(ctx context.Context, ownerID, offset, limit int) ([]types.Contest, int, error)
	...
	ApproveContest(ctx context.Context, id int) error
	RejectContest(ctx context.Context, id int) error
...
func (s *ContestService) ListContests(ctx context.Context, offset, limit int, publicOnly bool) ([]types.Contest, int, error) {
	return s.repo.ListContests(ctx, offset, limit, publicOnly)
}

func (s *ContestService) ListPendingContests(ctx context.Context, offset, limit int) ([]types.Contest, int, error) {
	return s.repo.ListPendingContests(ctx, offset, limit)
}

func (s *ContestService) ListContestsByOwner(ctx context.Context, ownerID, offset, limit int) ([]types.Contest, int, error) {
	return s.repo.ListContestsByOwner(ctx, ownerID, offset, limit)
}
...
func (s *ContestService) ApproveContest(ctx context.Context, id int) error {
	return s.repo.ApproveContest(ctx, id)
}

func (s *ContestService) RejectContest(ctx context.Context, id int) error {
	return s.repo.RejectContest(ctx, id)
}
