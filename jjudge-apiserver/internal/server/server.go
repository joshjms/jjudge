...
func New(ctx context.Context, cfg *config.Config) (*Server, error) {
	...
	submissionHandler := handlers.NewSubmissionHandler(submissionService, problemService)
	...
	router.Route("/contests", func(r chi.Router) {
		handlers.ContestRouter(r, contestService, problemService, userService, authMiddleware)
	})
