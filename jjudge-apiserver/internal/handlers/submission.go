...
func NewSubmissionHandler(submissionService *services.SubmissionService, problemService *services.ProblemService) *SubmissionHandler {
...
func SubmissionRouter(
	...
	handler := NewSubmissionHandler(submissionService, problemService)
